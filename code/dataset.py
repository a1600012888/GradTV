...
def produce_benchmark_datatsets(root = '../data', num = 100):
    ...
    benchmark_datasets_dir = os.path.join(root, 'benchmark_data')
...
class benchmark_dataset(Dataset):
    ...
    def __init__(self, benchmark_dir = '../data/benchmark_data', num = 100, transform = None):
    ...
    def __getitem__(self, idx):
        ...
        return sample
def create_benchmark_dataset(batchsize = 100, bechmark_dir = '../data/benchmark_data'):
